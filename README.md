...
Saved DANN results are in `DomainAdversialNN/results/evaluationResult.csv`:
...
- `synthetic-data/synthetic_{claude,deepseek,mistral}_qa.csv`: synthetic
  ...
  generalization.
- `DomainAdversialNN/results/evaluationResult.csv`: saved DANN OOD evaluation
  results for the final phase-2 checkpoint, including CoQA and CommonLit.
- `DomainAdversialNN/results/confusion_matrices/`: confusion matrix images for
  the DANN OOD evaluations.
